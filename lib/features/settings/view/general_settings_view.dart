...
class _NavItemState extends SafeState<_NavItem> {
...
class _SettingsTextFieldState extends SafeState<_SettingsTextField> {
...
class _SmallActionButtonState extends SafeState<_SmallActionButton> {
  bool _isHovered = false;
...
class _SaveButtonState extends SafeState<_SaveButton> {
  bool _isHovered = false;
...
class _MaintenanceConfirmationDialogState
    extends SafeState<_MaintenanceConfirmationDialog> {
  int _countdown = 3;
  Timer? _timer;
