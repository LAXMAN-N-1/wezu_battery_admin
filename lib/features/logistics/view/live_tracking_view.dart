...
class _LiveTrackingViewState extends SafeState<LiveTrackingView> {
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text(
                    'Real-time delivery tracking and driver positions.',
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text(
              _errorMessage ?? 'Unable to load live tracking data.',
