...
class _DealerOnboardingViewState extends State<DealerOnboardingView> {
  ...
  final List<Map<String, dynamic>> _stages = [
    ...
    {
      'key': 'MANUAL_REVIEW_PASSED',
      'label': 'Review Passed',
      'icon': Icons.rate_review_outlined,
      'color': const Color(0xFF8B5CF6),
    },
    {
      'key': 'FIELD_VISIT_SCHEDULED',
      'label': 'Visit Scheduled',
      'icon': Icons.calendar_month_outlined,
      'color': const Color(0xFFF97316),
    },
    {
      'key': 'FIELD_VISIT_COMPLETED',
      'label': 'Visit Done',
  ...
  Future<void> _loadAllCounts() async {
    final futures = _stages.map(
      (stage) => _repository
          .getApplications(stage: stage['key'])
          .then((apps) => MapEntry(stage['key'] as String, apps.length)),
    );
  ...
  Widget build(BuildContext context) {
    ...
    final pendingStages = _stages
        .map((stage) => stage['key'] as String)
        .where((stage) => !{'APPROVED', 'ACTIVE', 'REJECTED'}.contains(stage));
    final pending = pendingStages.fold<int>(
      0,
      (sum, stage) => sum + (_stageCounts[stage] ?? 0),
    );
      ...
      child: Column(
        ...
        children: [
          PageHeader(
            ...
            subtitle: 'Manage the dealer onboarding pipeline.',
            actionButton: Row(
              children: [
                IconButton(
                    ...
                    child: InkWell(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          color: isSelected
                              ? (stage['color'] as Color).withValues(
                                  alpha: 0.15,
                                )
                              : Colors.transparent,
                          borderRadius: BorderRadius.circular(12),
                          ...
                          children: [
                            ...
                            if (count > 0) ...[
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: (stage['color'] as Color).withValues(
                                    alpha: 0.2,
                                  ),
            ...
            child: _isLoading
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'No applications in ${_selectedStage.replaceAll('_', ' ')} stage.',
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final stageData = _stages.firstWhere(
                        (s) => s['key'] == app.currentStage,
                        orElse: () => _stages[0],
                      );
              ...
              Row(
                children: [
                  Container(
                    padding: const EdgeInsets.all(12),
                    decoration: BoxDecoration(
                      color: (nextData['color'] as Color).withValues(
                        alpha: 0.1,
                      ),
                      borderRadius: BorderRadius.circular(12),
                    ),
                    child: Icon(
                      nextData['icon'] as IconData,
                      color: nextData['color'] as Color,
                      size: 24,
                    ),
                  ),
                  const SizedBox(width: 16),
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: nextData['color'] as Color,
                      foregroundColor: Colors.white,
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(12),
                      ),
