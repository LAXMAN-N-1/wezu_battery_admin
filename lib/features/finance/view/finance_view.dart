...
class _FinanceViewState extends SafeState<FinanceView> {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              _statCard(
                'Period Revenue',
                '₹${NumberFormat('#,##0').format(_periodRevenue)}',
              ...
              _statCard(
                'Growth',
                '${_monthlyGrowth >= 0 ? "+" : ""}$_monthlyGrowth%',
  ...
  Widget _periodChip(String value, String label) => Padding(
    ...
    child: FilterChip(
      ...
      label: Text(
        label,
        style: TextStyle(
          color: _period == value ? Colors.white : Colors.white54,
          fontSize: 11,
        ),
      ),
  ...
  Widget _typeBadge(String type) {
    final colors = {
      'RENTAL_PAYMENT': const Color(0xFF3B82F6),
      'SUBSCRIPTION': const Color(0xFF8B5CF6),
      'PURCHASE': const Color(0xFF22C55E),
      'REFUND': const Color(0xFFEF4444),
      'SWAP_FEE': const Color(0xFF14B8A6),
    };
        ...
        titlesData: FlTitlesData(
          ...
          bottomTitles: AxisTitles(
            sideTitles: SideTitles(
              ...
              interval: 1,
              getTitlesWidget: (v, m) =>
                  v.toInt() >= 0 && v.toInt() < _chartData.length
                  ? SideTitleWidget(
                      meta: m,
                      child: Text(
                        _chartData[v.toInt()]['month'],
                        style: const TextStyle(
                          color: Colors.white54,
                          fontSize: 11,
                        ),
  ...
  Widget _buildTypeBreakdown() {
    final total = _revenueByType.fold<double>(
      0,
  ...
  String _friendlyError(Object error) {
    ...
    return 'Unable to load finance dashboard right now.';
  }
}
