...
class _ProfitAnalysisViewState extends SafeState<ProfitAnalysisView> {
  ...
  Widget build(BuildContext context) {
    ...
    final platformFees =
        (_data['total_platform_fees'] as num?)?.toDouble() ?? 0;
    ...
    final marginColor = _profitColor(margin);
      ...
      child: Column(
        ...
        children: [
          PageHeader(
            ...
            subtitle: 'Revenue, costs, margins, and profitability insights.',
              ...
              rows: trend.map((m) {
                ...
                return [
                  ...
                  Text(
                    ...
                    style: TextStyle(color: _profitColor(mg)),
                  ),
                ];
              }).toList(),
            ),
  ...
  String _friendlyError(Object error) {
    ...
    return 'Unable to load profit analysis right now.';
  }
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text(
              _errorMessage ?? 'Unable to load profit analysis.',
  ...
  Widget _bigStat(String title, double value, Color color, IconData icon) =>
      Expanded(
        child: AdvancedCard(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
        ...
        titlesData: FlTitlesData(
          ...
          bottomTitles: AxisTitles(
            sideTitles: SideTitles(
              ...
              getTitlesWidget: (v, m) {
                final i = v.toInt();
                return i >= 0 && i < trend.length
                    ? SideTitleWidget(
                        meta: m,
                        child: Text(
                          (trend[i]['month'] ?? '').toString().split(' ').first,
                          style: const TextStyle(
        ...
        barGroups: trend
            ...
            .map(
              (e) => BarChartGroupData(
                ...
                barRods: [
                  BarChartRodData(
                    toY: (e.value['revenue'] as num?)?.toDouble() ?? 0,
                  ...
                  BarChartRodData(
                    toY: (e.value['costs'] as num?)?.toDouble() ?? 0,
                  ...
                  BarChartRodData(
                    toY: (e.value['profit'] as num?)?.toDouble() ?? 0,
  ...
  Widget _buildPieChart(List<Map<String, dynamic>> data) {
    ...
    final total = data.fold<double>(
      0,
      (s, d) => s + (d['amount'] as num).toDouble(),
    );
          ...
          return Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    (e.value['type'] as String).replaceAll('_', ' '),
                    style: const TextStyle(color: Colors.white54, fontSize: 10),
                    overflow: TextOverflow.ellipsis,
                  ),
                ),
