                    ...
                    Row(
                      children: [
                        _buildQuickSelect(
                          'All',
                          () => setState(
                            () => _selectedIds.addAll(_users.map((u) => u.id)),
                          ),
                        ),
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      ...
                      items: const [
                        ...
                        DropdownMenuItem(
                          value: 'update',
                          child: Text('Platform Update'),
                        ),
                        DropdownMenuItem(
                          value: 'reminder',
                          child: Text('Rental Reminder'),
                        ),
                        DropdownMenuItem(
                          value: 'custom',
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              'Status: ${result['status']}. Processed ${result['processed']} users.',
            ),
