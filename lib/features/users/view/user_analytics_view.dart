      ...
      child: Column(
        ...
        children: [
          PageHeader(
            ...
            subtitle: 'Login patterns, rental frequency, and device usage insights',
          ).animate().fadeIn(duration: 400.ms).slideY(begin: -0.1),

          // Summary cards
          Row(
            children: [
              _buildSummaryCard('Daily Logins', _loginHistory.isNotEmpty ? (_loginHistory.last['logins']?.toString() ?? '0') : '0', const Color(0xFF3B82F6), Icons.login),
              const SizedBox(width: 16),
              _buildSummaryCard('Data Points', _deviceBreakdown.values.fold<int>(0, (sum, value) => sum + value).toString(), const Color(0xFF22C55E), Icons.people),
              const SizedBox(width: 16),
              _buildSummaryCard('Tracked Months', _rentalFrequency.length.toString(), const Color(0xFF8B5CF6), Icons.timer),
              const SizedBox(width: 16),
              _buildSummaryCard('Device Types', _deviceBreakdown.length.toString(), const Color(0xFFF59E0B), Icons.replay),
            ],
                        ...
                        child: PieChart(
                          PieChartData(
                            ...
                            sections: _deviceBreakdown.entries.toList().asMap().entries.map((e) {
                              final colors = [const Color(0xFF3B82F6), const Color(0xFF22C55E), const Color(0xFF8B5CF6), const Color(0xFFF59E0B)];
          ...
          AdvancedCard(
            ...
            child: Column(
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.all(24),
                  child: Text('Recent Login Sessions', style: GoogleFonts.outfit(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600)),
                ),
