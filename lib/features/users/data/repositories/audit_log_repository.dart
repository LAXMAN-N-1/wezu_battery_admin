...
class AuditLogRepository {
  ...
  static const _adminAuditBase = '/api/v1/admin/audit-logs';
  static const _auditBase = '/api/v1/audit';

  static final List<AuditLog> _logs = [
    AuditLog(
      id: '1',
      userId: 1,
      userName: 'Murari Varma',
      action: 'login',
      module: 'auth',
    ...
    AuditLog(
      ...
      action: 'update',
      module: 'users',
      details: 'Updated user profile for Rahul Sharma',
      ipAddress: '192.168.1.100',
      userAgent: 'Chrome 120 / Windows',
      timestamp: DateTime.now().subtract(const Duration(minutes: 15)),
      beforeValue: 'role: driver',
      afterValue: 'role: driver',
    ),
    AuditLog(
      id: '3',
      userId: 7,
      ...
      action: 'kyc_reject',
      module: 'kyc',
      details: 'Rejected KYC for Suresh Kumar — blurry document',
      ipAddress: '103.55.90.12',
      userAgent: 'Firefox 121 / Mac',
    ...
    AuditLog(
      ...
      action: 'suspend',
      module: 'users',
      details: 'Suspended Kavita Reddy — fraud suspected',
      ipAddress: '192.168.1.100',
      userAgent: 'Chrome 120 / Windows',
    ...
    AuditLog(
      ...
      module: 'roles',
      details: 'Removed finance.manage from Supervisor role',
      ipAddress: '192.168.1.100',
      userAgent: 'Chrome 120 / Windows',
      timestamp: DateTime.now().subtract(const Duration(hours: 8)),
      beforeValue: 'finance.manage: true',
      afterValue: 'finance.manage: false',
    ),
    AuditLog(
      id: '6',
      userId: 8,
    ...
    AuditLog(
      ...
      action: 'kyc_approve',
      module: 'kyc',
      details: 'Approved KYC for Amit Patel',
      ipAddress: '103.55.90.12',
      userAgent: 'Firefox 121 / Mac',
    ...
    AuditLog(
      ...
      action: 'create',
      module: 'users',
      details: 'Created new user account for Vikram Malhotra',
      ipAddress: '192.168.1.100',
      userAgent: 'Chrome 120 / Windows',
    ...
    AuditLog(
      ...
      action: 'update',
      module: 'settings',
      details: 'Updated platform timezone to IST',
      ipAddress: '192.168.1.100',
      userAgent: 'Chrome 120 / Windows',
    ...
    AuditLog(
      ...
      action: 'reactivate',
      module: 'users',
      details: 'Reactivated account for Suresh Kumar',
      ipAddress: '103.55.90.12',
      userAgent: 'Firefox 121 / Mac',
    ...
    AuditLog(
      ...
      action: 'delete',
      module: 'users',
      details: 'Deleted inactive test account',
      ipAddress: '192.168.1.100',
      userAgent: 'Chrome 120 / Windows',
  ...
  Future<List<AuditLog>> getUserAuditLog(
    int userId, {
    int page = 1,
    int limit = 20,
  }) async {
  ...
  Future<List<AuditLog>> getRoleAuditLog(
    int roleId, {
    int page = 1,
    int limit = 20,
  }) async {
    try {
      final response = await _apiClient.get(
        '$_auditBase/roles/$roleId/changes',
        queryParameters: {'page': page, 'limit': limit},
      );
      final List data = response.data['logs'] ?? [];
      return data.map((json) => AuditLog.fromJson(json)).toList();
  ...
  Future<dynamic> getPermissionUsage() async {
    try {
      final response = await _apiClient.get('$_auditBase/permissions/usage');
  ...
  Future<List<AuditLog>> getAuthFailures({
    int? userId,
    int page = 1,
    int limit = 20,
  }) async {
  ...
  Future<bool> exportLogs({String? action, String? module}) async {
    try {
      ...
      if (module != null && module != 'all') query['resource_type'] = module;

      await _apiClient.get(
        '$_adminAuditBase/export/json',
